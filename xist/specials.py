...
import sys
import xsc
import html40transitional

class plaintable(html40transitional.table):
	close = 1

	def AsHTML(self,mode = None):
		e = html40transitional.table(xsc.AsHTML(self.content,mode),xsc.AsHTML(self.attrs,mode))
...
class plainbody(html40transitional.body):
	close = 1

	def AsHTML(self,mode = None):
		e = html40transitional.body(xsc.AsHTML(self.content,mode),xsc.AsHTML(self.attrs,mode))
...
xsc.XSC.handlers["filesize"] = filesize
