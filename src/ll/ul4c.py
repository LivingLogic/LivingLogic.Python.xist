...
class CallMeth(AST):
	...
	def formatjava(self, indent):
		methods = dict(
			...
			r="com.livinglogic.ul4.MethodR({})"..callformat,
			g="com.livinglogic.ul4.MethodG({})"..callformat,
			b="com.livinglogic.ul4.MethodB({})"..callformat,
			a="com.livinglogic.ul4.MethodA({})"..callformat,
