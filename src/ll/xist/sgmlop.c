...
static PyObject*
feed(FastSGMLParserObject* self, char* string, Py_ssize_t stringlen, int last)
{
...
typedef struct {
    ...
    Py_ssize_t child_count; /* actual items */
    Py_ssize_t child_total; /* allocated items */
    PyObject* *children;
 ...
 */
static int
fetchEncoding(FastSGMLParserObject* self, const CHAR_T* data, Py_ssize_t len)
{
 ...
 */
static PyObject*
stringFromData(FastSGMLParserObject* self, const CHAR_T* data, Py_ssize_t len)
{
#ifdef Py_USING_UNICODE
    if (self->unicode)
 ...
 */
static int
callWithString(FastSGMLParserObject* self, PyObject* callback, const CHAR_T* data, Py_ssize_t  len)
{
 ...
 */
static int
callWith2Strings(FastSGMLParserObject* self, PyObject* callback, const CHAR_T* data1, Py_ssize_t  len1, const CHAR_T* data2, Py_ssize_t  len2)
{
    PyObject* res;
     PyObject* str1;
     PyObject* str2;
 ...
 */
static int
callWithStringAndObj(FastSGMLParserObject* self, PyObject* callback, const CHAR_T* data, Py_ssize_t  len, PyObject *obj)
{
    PyObject* res;
    PyObject* str = stringFromData(self, data, len);
