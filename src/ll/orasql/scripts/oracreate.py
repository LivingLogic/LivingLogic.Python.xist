...
## Copyright 2005-2022 by LivingLogic AG, Bayreuth/Germany
## Copyright 2005-2022 by Walter Dörwald
##
## All Rights Reserved
##
...
so that no errors happen for nonexistent objects during script execution).
