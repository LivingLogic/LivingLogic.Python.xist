...
AddAST.add_rules(t"{'T2'} <- {dt.MONTHDELTA} + {[dt.DATE, dt.DATETIME]}", oracle=t"vsqlimpl_pkg.add_months_{'t2'}({'s1'}, {'s2'})", postgres=t"vsqlimpl.add_{'t2'}_months({'s2'}, {'s1'})")
...
MulAST.add_rules(t"{'T1'} <- {TEXT} * {dt.BOOL}", oracle=t"vsqlimpl_pkg.mul_{'t1'}_int({'s1'}, {'s2'})", postgres=t"vsqlimpl.mul_{'t1'}_int({'s1'}, {'s2'}::int::bigint)")
MulAST.add_rules(t"{'T1'} <- {TEXT} * {dt.INT}", oracle=t"vsqlimpl_pkg.mul_{'t1'}_int({'s1'}, {'s2'})", postgres=t"vsqlimpl.mul_{'t1'}_int({'s1'}, {'s2'})")
