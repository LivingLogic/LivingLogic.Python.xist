...
GTAST.add_rules(f"BOOL <- {INTLIKE} > {INTLIKE}", "case vsqlimpl_pkg.cmp_int_int({s1}, {s2}) when 1 then 1 when null then null else 0 end")
GTAST.add_rules(f"BOOL <- {NUMBERLIKE} > {NUMBERLIKE}", "case vsqlimpl_pkg.cmp_{t1}_{t2}({s1}, {s2}) when 1 then 1 when null then null else 0 end")
GTAST.add_rules(f"BOOL <- {TEXT} > {TEXT}", "case vsqlimpl_pkg.cmp_{t1}_{t2}({s1}, {s2}) when 1 then 1 when null then null else 0 end")
GTAST.add_rules(f"BOOL <- DATE_DATETIME > T1", "case vsqlimpl_pkg.cmp_{t1}_{t2}({s1}, {s2}) when 1 then 1 when null then null else 0 end")
GTAST.add_rules(f"BOOL <- DATEDELTA > DATEDELTA", "case vsqlimpl_pkg.cmp_int_int({s1}, {s2}) when 1 then 1 when null then null else 0 end")
GTAST.add_rules(f"BOOL <- DATETIMEDELTA > DATETIMEDELTA", "case vsqlimpl_pkg.cmp_number_number({s1}, {s2}) when 1 then 1 when null then null else 0 end")
GTAST.add_rules(f"BOOL <- INTLIST_NUMBERLIST > INTLIST_NUMBERLIST", "case vsqlimpl_pkg.cmp_{t1}_{t2}({s1}, {s2}) when 1 then 1 when null then null else 0 end")
GTAST.add_rules(f"BOOL <- STRLIST_CLOBLIST > STRLIST_CLOBLIST", "case vsqlimpl_pkg.cmp_{t1}_{t2}({s1}, {s2}) when 1 then 1 when null then null else 0 end")
GTAST.add_rules(f"BOOL <- DATELIST_DATETIMELIST > T1", "case vsqlimpl_pkg.cmp_{t1}_{t2}({s1}, {s2}) when 1 then 1 when null then null else 0 end")
GTAST.add_rules(f"BOOL <- NULLLIST > NULLLIST_{LIST}", "case vsqlimpl_pkg.cmp_{t1}_{t2}({s1}, {s2}) when 1 then 1 when null then null else 0 end")
GTAST.add_rules(f"BOOL <- NULLLIST_{LIST} > NULLLIST", "case vsqlimpl_pkg.cmp_{t1}_{t2}({s1}, {s2}) when 1 then 1 when null then null else 0 end")
...
GEAST.add_rules(f"BOOL <- {INTLIKE} >= {INTLIKE}", "case vsqlimpl_pkg.cmp_int_int({s1}, {s2}) when -1 then 0 when null then null else 1 end")
GEAST.add_rules(f"BOOL <- {NUMBERLIKE} >= {NUMBERLIKE}", "case vsqlimpl_pkg.cmp_{t1}_{t2}({s1}, {s2}) when -1 then 0 when null then null else 1 end")
GEAST.add_rules(f"BOOL <- {TEXT} >= {TEXT}", "case vsqlimpl_pkg.cmp_{t1}_{t2}({s1}, {s2}) when -1 then 0 when null then null else 1 end")
GEAST.add_rules(f"BOOL <- DATE_DATETIME >= T1", "case vsqlimpl_pkg.cmp_{t1}_{t2}({s1}, {s2}) when -1 then 0 when null then null else 1 end")
GEAST.add_rules(f"BOOL <- DATEDELTA >= DATEDELTA", "case vsqlimpl_pkg.cmp_int_int({s1}, {s2}) when -1 then 0 when null then null else 1 end")
GEAST.add_rules(f"BOOL <- DATETIMEDELTA >= DATETIMEDELTA", "case vsqlimpl_pkg.cmp_number_number({s1}, {s2}) when -1 then 0 when null then null else 1 end")
GEAST.add_rules(f"BOOL <- INTLIST_NUMBERLIST >= INTLIST_NUMBERLIST", "case vsqlimpl_pkg.cmp_{t1}_{t2}({s1}, {s2}) when -1 then 0 when null then null else 1 end")
GEAST.add_rules(f"BOOL <- STRLIST_CLOBLIST >= STRLIST_CLOBLIST", "case vsqlimpl_pkg.cmp_{t1}_{t2}({s1}, {s2}) when -1 then 0 when null then null else 1 end")
GEAST.add_rules(f"BOOL <- DATELIST_DATETIMELIST >= T1", "case vsqlimpl_pkg.cmp_{t1}_{t2}({s1}, {s2}) when -1 then 0 when null then null else 1 end")
GEAST.add_rules(f"BOOL <- NULLLIST >= NULLLIST_{LIST}", "case vsqlimpl_pkg.cmp_{t1}_{t2}({s1}, {s2}) when -1 then 0 when null then null else 1 end")
GEAST.add_rules(f"BOOL <- NULLLIST_{LIST} >= NULLLIST", "case vsqlimpl_pkg.cmp_{t1}_{t2}({s1}, {s2}) when -1 then 0 when null then null else 1 end")
...
LTAST.add_rules(f"BOOL <- {INTLIKE} < {INTLIKE}", "case vsqlimpl_pkg.cmp_int_int({s1}, {s2}) when -1 then 1 when null then null else 0 end")
LTAST.add_rules(f"BOOL <- {NUMBERLIKE} < {NUMBERLIKE}", "case vsqlimpl_pkg.cmp_{t1}_{t2}({s1}, {s2}) when -1 then 1 when null then null else 0 end")
LTAST.add_rules(f"BOOL <- {TEXT} < {TEXT}", "case vsqlimpl_pkg.cmp_{t1}_{t2}({s1}, {s2}) when -1 then 1 when null then null else 0 end")
LTAST.add_rules(f"BOOL <- DATE_DATETIME < T1", "case vsqlimpl_pkg.cmp_{t1}_{t2}({s1}, {s2}) when -1 then 1 when null then null else 0 end")
LTAST.add_rules(f"BOOL <- DATEDELTA < DATEDELTA", "case vsqlimpl_pkg.cmp_int_int({s1}, {s2}) when -1 then 1 when null then null else 0 end")
LTAST.add_rules(f"BOOL <- DATETIMEDELTA < DATETIMEDELTA", "case vsqlimpl_pkg.cmp_number_number({s1}, {s2}) when -1 then 1 when null then null else 0 end")
LTAST.add_rules(f"BOOL <- INTLIST_NUMBERLIST < INTLIST_NUMBERLIST", "case vsqlimpl_pkg.cmp_{t1}_{t2}({s1}, {s2}) when -1 then 1 when null then null else 0 end")
LTAST.add_rules(f"BOOL <- STRLIST_CLOBLIST < STRLIST_CLOBLIST", "case vsqlimpl_pkg.cmp_{t1}_{t2}({s1}, {s2}) when -1 then 1 when null then null else 0 end")
LTAST.add_rules(f"BOOL <- DATELIST_DATETIMELIST < T1", "case vsqlimpl_pkg.cmp_{t1}_{t2}({s1}, {s2}) when -1 then 1 when null then null else 0 end")
LTAST.add_rules(f"BOOL <- NULLLIST < NULLLIST_{LIST}", "case vsqlimpl_pkg.cmp_{t1}_{t2}({s1}, {s2}) when -1 then 1 when null then null else 0 end")
LTAST.add_rules(f"BOOL <- NULLLIST_{LIST} < NULLLIST", "case vsqlimpl_pkg.cmp_{t1}_{t2}({s1}, {s2}) when -1 then 1 when null then null else 0 end")
...
LEAST.add_rules(f"BOOL <- {INTLIKE} <= {INTLIKE}", "case vsqlimpl_pkg.cmp_int_int({s1}, {s2}) when 1 then 0 when null then null else 1 end")
LEAST.add_rules(f"BOOL <- {NUMBERLIKE} <= {NUMBERLIKE}", "case vsqlimpl_pkg.cmp_{t1}_{t2}({s1}, {s2}) when 1 then 0 when null then null else 1 end")
LEAST.add_rules(f"BOOL <- {TEXT} <= {TEXT}", "case vsqlimpl_pkg.cmp_{t1}_{t2}({s1}, {s2}) when 1 then 0 when null then null else 1 end")
LEAST.add_rules(f"BOOL <- DATE_DATETIME <= T1", "case vsqlimpl_pkg.cmp_{t1}_{t2}({s1}, {s2}) when 1 then 0 when null then null else 1 end")
LEAST.add_rules(f"BOOL <- DATEDELTA <= DATEDELTA", "case vsqlimpl_pkg.cmp_int_int({s1}, {s2}) when 1 then 0 when null then null else 1 end")
LEAST.add_rules(f"BOOL <- DATETIMEDELTA <= DATETIMEDELTA", "case vsqlimpl_pkg.cmp_number_number({s1}, {s2}) when 1 then 0 when null then null else 1 end")
LEAST.add_rules(f"BOOL <- INTLIST_NUMBERLIST <= INTLIST_NUMBERLIST", "case vsqlimpl_pkg.cmp_{t1}_{t2}({s1}, {s2}) when 1 then 0 when null then null else 1 end")
LEAST.add_rules(f"BOOL <- STRLIST_CLOBLIST <= STRLIST_CLOBLIST", "case vsqlimpl_pkg.cmp_{t1}_{t2}({s1}, {s2}) when 1 then 0 when null then null else 1 end")
LEAST.add_rules(f"BOOL <- DATELIST_DATETIMELIST <= T1", "case vsqlimpl_pkg.cmp_{t1}_{t2}({s1}, {s2}) when 1 then 0 when null then null else 1 end")
LEAST.add_rules(f"BOOL <- NULLLIST <= NULLLIST_{LIST}", "case vsqlimpl_pkg.cmp_{t1}_{t2}({s1}, {s2}) when 1 then 0 when null then null else 1 end")
LEAST.add_rules(f"BOOL <- NULLLIST_{LIST} <= NULLLIST", "case vsqlimpl_pkg.cmp_{t1}_{t2}({s1}, {s2}) when 1 then 0 when null then null else 1 end")
