...
all: $(OUTPUTDIR)/xist $(OUTPUTDIR)/xist/ns $(DEP) $(OUTPUTDIR)/xist/helpers.so

dist:
	dbl2t --title History --import xist.ns.abbr --import xist.ns.docbooklite --import xist.ns.specials NEWS.xml NEWS
