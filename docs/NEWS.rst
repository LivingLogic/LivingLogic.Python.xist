...
*	The default value for the owner parameter in various :mod:`ll.orasql` methods
	has changed from `ALL` to `None` (i.e. it now returns the objects from the
	current schema instead of all schemas).
