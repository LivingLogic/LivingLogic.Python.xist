...
with url.Context():
	versions = [
		Version("5.72", "08/04/2022"),
		Version("5.71", "07/08/2022"),
		Version("5.70", "03/11/2022"),
		Version("5.69.1", "12/13/2021"),
		...
		Version("5.63.1", "10/26/2020"),
		Version("5.63", "09/08/2020"),
		Version("5.62", "07/13/2020"),
		Version("5.61.2", "07/09/2020"),
		Version("5.61.1", "07/09/2020"),
		Version("5.61", "07/07/2020"),
		Version("5.60", "07/03/2020"),
		Version("5.59", "06/30/2020"),
		Version("5.58", "06/12/2020"),
		Version("5.57", "04/14/2020"),
		Version("5.56", "12/12/2019"),
		Version("5.55", "11/11/2019"),
		Version("5.54.1", "10/24/2019"),
		Version("5.54", "10/24/2019"),
		Version("5.53", "09/30/2019"),
		Version("5.52.1", "09/05/2019"),
		Version("5.52", "07/29/2019"),
		Version("5.51", "07/26/2019"),
		Version("5.50", "07/16/2019"),
		Version("5.49", "07/04/2019"),
		Version("5.48", "07/03/2019"),
		Version("5.47", "07/01/2019"),
		Version("5.46", "06/26/2019"),
		Version("5.45", "06/24/2019"),
		Version("5.44", "06/07/2019"),
		Version("5.43", "05/07/2019"),
		Version("5.42.1", "04/29/2019"),
		Version("5.42", "04/26/2019"),
		Version("5.41", "03/29/2019"),
		Version("5.40.2", "03/26/2019"),
		Version("5.40.1", "03/25/2019"),
		Version("5.40", "03/25/2019"),
		Version("5.39", "01/30/2019"),
		Version("5.38", "11/15/2018"),
		Version("5.37.1", "11/13/2018"),
		Version("5.37", "11/08/2018"),
		Version("5.36", "10/31/2018"),
		Version("5.35", "09/14/2018"),
		Version("5.34", "06/03/2018"),
		Version("5.33", "05/15/2018"),
		Version("5.32", "02/20/2018"),
		Version("5.31", "01/29/2018"),
		Version("5.30", "01/17/2018"),
		Version("5.29", "11/29/2017"),
		Version("5.28.2", "08/03/2017"),
		Version("5.28.1", "08/02/2017"),
		Version("5.28", "08/01/2017"),
