...
def test_function_format(r):
	...
	eq("Jan", r(code3, format="%b", data=t, lang="de"))
	eq("Jan", r(code3, format="%b", data=t, lang="de_DE"))
	eq("January", r(code2, format="%B", data=t))
	eq("January", r(code3, format="%B", data=t, lang=None))
	eq("January", r(code3, format="%B", data=t, lang="en"))
	...
	contains(("Tue Jan 25 13:34:56 2011", "Tue 25 Jan 2011 01:34:56 PM", "Tue 25 Jan 2011 01:34:56 PM "), r(code2, format="%c", data=t))
	...
	contains(("13:34:56", "01:34:56 PM"), r(code2, format="%X", data=t))
	contains(("13:34:56", "01:34:56 PM"), r(code3, format="%X", data=t, lang=None))
	contains(("13:34:56", "01:34:56 PM"), r(code3, format="%X", data=t, lang="en"))
	eq("13:34:56", r(code3, format="%X", data=t, lang="de"))
	eq("13:34:56", r(code3, format="%X", data=t, lang="de_DE"))
	eq("%", r(code2, format="%%", data=t))
