...
def test_bool_none2(db, vsql_data):
	assert expr(db, "r.v_bool >= None", where="r.identifier == 'bool_false'")
...
def test_intlist_none(db, vsql_data):
	assert expr(db, "[1, 2] >= None")


def test_numberlist_none(db, vsql_data):
	assert expr(db, "[1.2, 3.4] >= None")


def test_strlist_none(db, vsql_data):
	assert expr(db, "['foo', 'bar'] >= None")
...
def test_none_bool2(db, vsql_data):
	assert not expr(db, "None >= r.v_bool", where="r.identifier == 'bool_false'")


def test_none_bool3(db, vsql_data):
	assert not expr(db, "None >= r.v_bool", where="r.identifier == 'bool_true'")
...
def test_none_int2(db, vsql_data):
	assert not expr(db, "None >= r.v_int", where="r.identifier == 'int'")
...
def test_none_number2(db, vsql_data):
	assert not expr(db, "None >= r.v_number", where="r.identifier == 'number'")
...
def test_none_str2(db, vsql_data):
	assert not expr(db, "None >= r.v_str", where="r.identifier == 'str'")
...
def test_none_date2(db, vsql_data):
	assert not expr(db, "None >= r.v_date", where="r.identifier == 'date'")
...
def test_none_datetime2(db, vsql_data):
	assert not expr(db, "None >= r.v_datetime", where="r.identifier == 'datetime'")
...
def test_none_color2(db, vsql_data):
	assert not expr(db, "None >= r.v_color", where="r.identifier == 'color'")
...
def test_none_datedelta2(db, vsql_data):
	assert not expr(db, "None >= r.v_datedelta", where="r.identifier == 'datedelta'")
...
def test_none_datetimedelta2(db, vsql_data):
	assert not expr(db, "None >= r.v_datetimedelta", where="r.identifier == 'datetimedelta'")
...
def test_none_monthdelta2(db, vsql_data):
	assert not expr(db, "None >= r.v_monthdelta", where="r.identifier == 'monthdelta'")


def test_none_intlist(db, vsql_data):
	assert not expr(db, "None >= [1, 2]")


def test_none_numberlist(db, vsql_data):
	assert not expr(db, "None >= [1.2, 3.4]")


def test_none_strlist(db, vsql_data):
	assert not expr(db, "None >= ['foo', 'bar']")
...
def test_bool_bool2(db, vsql_data):
	assert not expr(db, "r.v_bool >= False", where="r.identifier == 'none'")


def test_bool_bool3(db, vsql_data):
	assert not expr(db, "r.v_bool >= True", where="r.identifier == 'none'")
...
def test_bool_int2(db, vsql_data):
	assert not expr(db, "r.v_bool >= -1", where="r.identifier == 'none'")
...
def test_bool_int8(db, vsql_data):
	assert not expr(db, "r.v_bool >= 2", where="r.identifier == 'bool_true'")
...
def test_bool_number2(db, vsql_data):
	assert not expr(db, "r.v_bool >= -1.0", where="r.identifier == 'none'")
...
def test_bool_number8(db, vsql_data):
	assert not expr(db, "r.v_bool >= 2.0", where="r.identifier == 'bool_true'")
...
def test_int_bool2(db, vsql_data):
	assert not expr(db, "r.v_int >= False", where="r.identifier == 'none'")


def test_int_bool3(db, vsql_data):
	assert not expr(db, "r.v_int >= True", where="r.identifier == 'none'")
...
def test_int_int2(db, vsql_data):
	assert not expr(db, "r.v_int >= 1", where="r.identifier == 'none'")


def test_int_int3(db, vsql_data):
	assert expr(db, "r.v_int >= 1776", where="r.identifier == 'int'")
...
def test_int_int5(db, vsql_data):
	assert expr(db, "1776 >= r.v_int", where="r.identifier == 'int'")
...
def test_number_bool2(db, vsql_data):
	assert not expr(db, "r.v_number >= False", where="r.identifier == 'none'")
...
def test_number_int2(db, vsql_data):
	assert not expr(db, "r.v_number >= 1", where="r.identifier == 'none'")
...
def test_number_number2(db, vsql_data):
	assert not expr(db, "r.v_number >= 1.0", where="r.identifier == 'none'")
