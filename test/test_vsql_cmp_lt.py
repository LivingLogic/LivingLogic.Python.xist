...
def test_bool_int8(vsql_db, vsql_data):
	assert vsql_db.expr("r.v_bool < 2", where="r.identifier == 'bool_true'")
...
def test_bool_number8(vsql_db, vsql_data):
	assert vsql_db.expr("r.v_bool < 2.0", where="r.identifier == 'bool_true'")
...
def test_int_int3(vsql_db, vsql_data):
	assert not vsql_db.expr("r.v_int < 1776", where="r.identifier == 'int'")
