...
def test_bool_int8(db, vsql_data):
	assert expr(db, "r.v_bool < 2", where="r.identifier == 'bool_true'")
...
def test_bool_number8(db, vsql_data):
	assert expr(db, "r.v_bool < 2.0", where="r.identifier == 'bool_true'")
...
def test_int_int3(db, vsql_data):
	assert not expr(db, "r.v_int < 1776", where="r.identifier == 'int'")
